...
The script Eval_PBSim_data.py was specially designed for benchmarking simulation of PBSim.

Usage example:
```python
python Eval_PBSim_data.py simulation_folder alignment.sam annotations.gtf group_list All_SS_iso.txt All_AS_iso.txt result.csv
```
 ...
 [6] result.csv: the results of evaluation.
 
 
 The script Eval_NanoSim_data.py was specially designed for benchmarking simulation of NanoSim.

Usage example:
```python
python Eval_NanoSim_data.py readfile.fa alignment.sam annotations.gtf group_list All_SS_iso.txt result.csv
```
 [1] readfile.fa: the reads generated by NanoSim.
 ...
 [5] result.csv: the results of evaluation.
